...
if __name__ == '__main__':
    ...
    results = model.train(name='debug0826_', data='webpm_obb1944.yaml', epochs=200, imgsz=640, fliplr=0.5, batch=32, workers=4,
                          plots=True, device="0,1")  # deterministic=True, seed=42,
    # results = model.train(
    #     name='backward_debug',
