...
if __name__ == '__main__':
    ...
    results = model.train(name='debug0825_', data='webpm_obb8.yaml', epochs=2, imgsz=640, fliplr=0.0, batch=2, workers=0,
                          plots=True, deterministic=True, seed=42, device="0")
    # results = model.train(
    #     name='backward_debug',
