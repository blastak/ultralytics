...
if __name__ == '__main__':
    ...
    results = model.train(name='backward_debug', data='webpm_obb1944.yaml', epochs=300, imgsz=640, fliplr=0.0, batch=32, workers=2,
                          plots=True, deterministic=True, seed=42, device="0,1")
    # results = model.train(
    #     name='backward_debug',
