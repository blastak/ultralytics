...
class QBBPredictor(DetectionPredictor):
    ...
    Future versions will implement true quadrilateral prediction logic.
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        ...
        This constructor sets up a QBBPredictor instance for quadrilateral bounding box detection tasks.
